...
### 🚀 快速开始
1.  **获取工具链**: 前往 [Releases](https://github.com/luluovo1/ollvm-ndk30-based-on-llvm21-/releases) 根据你的系统下载对应构建包 (Windows / Linux / macOS)。
2.  **本地安装**: 参考 [📖 USAGE.md](./USAGE.md) 中各平台的具体安装和配置步骤。
...
###  开发路线图 (Roadmap)
- [ ] 基于 NDK 30 (LLVM 21) 的源码移植。
- [ ] 适配 GitHub Actions 自动化 Windows 版构建。
- [ ] **[未来]** 支持更多的混淆强度控制 (Intensity control)。
- [ ] **[未来]** 引入更强的跨过程混淆分析及 VMP 层。
